 ...
 */
final class Version20230710081842 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE team_sponsor (team_id INT NOT NULL, sponsor_id INT NOT NULL, INDEX IDX_7EF5B8E3296CD8AE (team_id), INDEX IDX_7EF5B8E312F7FB51 (sponsor_id), PRIMARY KEY(team_id, sponsor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
